	  ...
	  _createClass(Slider, {
	    ...
	    init: {
	      value: function init() {
	        ...
	        this._stage.ondragstart = function () {
	          return false;
	        };
	      }
	    },
	    ...
	    _moveThumbToPosition: {
	      value: function _moveThumbToPosition(pos) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<div class=\"stage\"><div class=\"thumb\"></div></div>");;return buf.join("");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		module.hot.accept("!!B:\\js\\test\\webpack-slider\\node_modules\\css-loader\\index.js!B:\\js\\test\\webpack-slider\\node_modules\\stylus-loader\\index.js!B:\\js\\test\\webpack-slider\\es6-class\\slider\\slider.styl", function() {
			var newContent = require("!!B:\\js\\test\\webpack-slider\\node_modules\\css-loader\\index.js!B:\\js\\test\\webpack-slider\\node_modules\\stylus-loader\\index.js!B:\\js\\test\\webpack-slider\\es6-class\\slider\\slider.styl");
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.push([module.id, ".stage {\n  border-radius: 5px;\n  background: #e0e0e0;\n  background: -moz-linear-gradient(left top, #e0e0e0, #eee) repeat scroll 0 0 transparent;\n  background: -webkit-gradient(linear, left top, right bottom, from(#e0e0e0), to(#eee));\n  background: linear-gradient(left top, #e0e0e0, #eee);\n  width: 310px;\n  height: 15px;\n  margin: 5px;\n}\n.thumb {\n  width: 10px;\n  height: 25px;\n  border-radius: 3px;\n  position: relative;\n  left: 10px;\n  top: -5px;\n  background: #f00;\n  cursor: pointer;\n}\n", ""]);
